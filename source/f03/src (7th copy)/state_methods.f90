...
!----------------------------------------------------------------------*
!print*,ssv(co1)%no_lai_comps,ssv(co1)%stem%no,ssv(co1)%no_root_comps,ssv(co1)%no_suma_comps
!print*,ssv(co2)%no_lai_comps,ssv(co2)%stem%no,ssv(co2)%no_root_comps,ssv(co2)%no_suma_comps
!----------------------------------------------------------------------*
