      ...
      open(11,file='islscp2_soils_1deg/soil_bulk_dens0-30_1d.asc')
      open(12,file='islscp2_soils_1deg/soil_sand_perc0-30_1d.asc')
      open(13,file='islscp2_soils_1deg/soil_silt_perc0-30_1d.asc')
      open(14,file='islscp2_soils_1deg/soil_clay_perc0-30_1d.asc')
      open(15,file='islscp2_soils_1deg/soil_org_carb_perc0-30_1d.asc')
      open(16,file='islscp2_soils_1deg/soil_wilting_point0-30_1d.asc')
      open(17,file='islscp2_soils_1deg/soil_field_cap0-30_1d.asc')
      open(18,file='islscp2_soils_1deg/soil_sat_wat_cont0-30_1d.asc')
      open(19,file='islscp2_soils_1deg/soil_pawc0-30_1d.asc')
      open(20,file='islscp2_soils_1deg/soil_res_wat_cont0-30_1d.asc')
      open(21,file='islscp2_soils_1deg/soil_ksat0-30_1d.asc')
      open(22,file='islscp2_soils_1deg/soil_org_carb_dens0-30_1d.asc')
      open(23,file='islscp2_soils_1deg/soil_nitrogen_dens0-30_1d.asc')
      open(24,file='islscp2_soils_1deg/soil_therm_cap0_0-30_1d.asc')
      open(25,file='islscp2_soils_1deg/soil_therm_cap10_0-30_1d.asc')
      open(26,file='islscp2_soils_1deg/soil_therm_cap50_0-30_1d.asc')
      open(27,file='islscp2_soils_1deg/soil_therm_cap100_0-30_1d.asc')
      open(28,file='islscp2_soils_1deg/soil_texture0-30_1d.asc')

      open(29,file='../../../islscp/1deg_new/data.dat',status='old')

      open(31,file='../0-30/data.dat')
      open(32,file='../0-30/data_sdgvm.dat')
      ...
      DO i=1,180
        ...
        DO j=1,360
          IF (wilt(j).GT.0.0d0) THEN
            wilt(j) = wilt(j)/300.0d0
            field(j) = field(j)/300.0d0
          ENDIF
        ENDDO
